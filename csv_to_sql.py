...
if __name__ == '__main__':
	try:
		...
		print('Deu erro irmão, especifica o caminho do arquivo que será convertido aí')
		sys.exit()

	inserts = csv_to_sql(path, 'detalhes_jogo')
	path_saved = save_to_sql('detalhes_jogos.sql', inserts)
